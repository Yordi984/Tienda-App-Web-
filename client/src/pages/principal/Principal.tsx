      ...
      <div className="home-container">
        <div className="home-hero">
          ...
          <p className="home-subtitle">
            Únete como <strong>vendedor</strong> o <strong>comprador</strong> y forma parte de una comunidad que impulsa oportunidades.
          </p>
          <div className="home-buttons">
            <button className="home-btn" onClick={() => navigate("/elegir_cuenta")}>
              Comenzar ahora
            </button>
        ...
        <div className="home-features">
          ...
          <div className="feature-card">
            ...
            <p>Publica, edita y administra tus artículos desde un solo lugar.</p>
          </div>
